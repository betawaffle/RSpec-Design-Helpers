...
module InterfaceDescriptionSpecHelper
  ...
  # fields - a Hash of sample assignment values that should be persisted after a #save and #reload.
  #   The key is an attribute name, and the value is both the assigned value and the expected value
  #   of the attribute after a save and reload.
  def persists(fields = {})
